...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~0C8xEIIB#leq7ooZL5Eb_zs2roAZ0C9ERR3-W_Kqnm81KumZWvaU", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "22898070887", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "22898070887", // Only 1 owner Number Here, others Add to sudo numbers...
