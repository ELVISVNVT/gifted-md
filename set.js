...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~FbchHJpL#DSgzWnnl4GDsEsStssRjdyI89kbOwLkfPDR0wJobhs8", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "22891983438", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "22891983438", // Only 1 owner Number Here, others Add to sudo numbers...
